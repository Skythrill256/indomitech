  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-300">
        Als Full-Service Agentur mit mehr als 20 Jahren Erfahrung in der Film- und 
        Videoproduktion erschaffen wir außergewöhnliche visuelle Erlebnisse, die Ihre 
        Marke zum Leben erwecken und Geschichten erzählen, die bewegen.
      </p>
    </div>
  );
};
